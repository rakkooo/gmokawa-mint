import * as KuruSdk from "https://esm.sh/@kuru-labs/kuru-sdk@0.0.46?alias=src/utils/txConfig:./empty.js";
...
async function buildMarketTx(size="1"){
  ...
  let cap;const o=tmp.sendTransaction.bind(tmp);
